...
@WebServlet("/ExecuteEliminaBigliettoServlet")
public class ExecuteEliminaBigliettoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			Biglietto result = MyServiceFactory.getBigliettoServiceInstance()
